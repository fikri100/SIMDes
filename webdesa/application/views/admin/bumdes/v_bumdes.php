						...
						<?php $i=1; foreach ($hasil as $w): ?>
							<tr>
								...
								<td class="tindakan">
									...
									<a href="<?=base_url("admin/$menu/form/ubah/$w->id_bumdes")?>" class="btn btn-success" title="Ubah">Ubah</a>
									<button onclick="proses('<?=base_url("admin/$menu/hapus/$w->id_bumdes")?>')" class="btn btn-danger" title="Hapus">Hapus</button>
								</td>
							</tr>
						<?php endforeach; ?>
					</tbody>
