			...
			<div class="row">
				<div class="col-md-12">
		              ...
		              <select class="form-control" name="bidang" required>
		                ...
		                foreach ($bidang as $v => $c){
		                  ...
		                  echo "<option value='$v' $s>$c</option>";
								...
								<div class="col-md-6">
			            <label for="" class="control-label modal-label">Ketua <span class="text-danger">*</span> </label>
			            <input class="form-control" type="text" name="ketua" value="<?=$detail->ketua?>" required>
			          </div>
								<div class="col-md-6">
                  ...
                  <textarea name="deskripsi" id="ckeditor" class="ckeditor form-control"><?=$detail->deskripsi?></textarea>
								...
								<div class="form-group col-md-12">
									<button name="bumdes" class="btn btn-fill btn-success form-control col-md-12 py-2">Simpan</button>
								</div>
							</div>
						<?php echo form_close(); ?>
					</div>
